...
// Declarative approach to access the data 
  user.forEach((x) => { 
    console.log(x.email)//returns only mails of the data
  })

 /*  user.forEach((x) => { 
    console.log(x)//returns data present inside the array, it does not return array 
  })
