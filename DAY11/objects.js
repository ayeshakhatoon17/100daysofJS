...
let  obj = {} //nothing is written in braces so it is an empty obj; obj in code is object name
 console.log(obj)// it reutns {}

 // creating a obj named person

let person ={ //creating a person obj and writing data
name : "Ayesha", 
age : 20,
occupation : "student"
 }
console.log(person) // to access the obj
console.log(person.name)//to access particular value in a object syntax: objname.key - it returns value of that key
...
// to access all the keys from the object (left side elements in object are known as keys) i.e name, occupation, mailid
for(let keys in person4){
  console.log(keys) // it reurns name  occupation mailid
}

// to access all the elements present in object (right side elements of an obj
console.log(person4)